...
def word_game():
    ...
    while True:
       ...
       ruword = translator.translate(word, src='en', dest='ru').text
       ruword_defenition = translator.translate(word_defenition, src='en', dest='ru').text
       print(f"Значение  сдова: {word_defenition}, {ruword_defenition}")  # выводит в консоль текст "Значение  сдова: {word_defenition}"
       user = input("Что это за слово ")  # выводит в консоль текст "Что это за слово " и получает данные в переменную user

       if user == ruword:  # если user равен word
           print("Верно, ТЫ КРАСАВЧИК!!!")  # выводит в консоль текст "Верно, ТЫ КРАСАВЧИК!!!"
       else:
           print(f"НЕВЕРНО, ТЫ НЕ КРАСАВЧИК!!! А вот слово было: {word}, {ruword}")  # выводит в консоль текст "НЕВЕРНО, ТЫ НЕ КРАСАВЧИК!!! А вот слово было: {word}"
